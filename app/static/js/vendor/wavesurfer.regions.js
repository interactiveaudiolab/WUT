...
WaveSurfer.Region = {
    ...
    render: function () {
        ...
        regionEl.className = 'mixture_waveform-region';
        ...
        if (this.resize) {
            ...
            handleLeft.className = 'mixture_waveform-handle mixture_waveform-handle-start';
            handleRight.className = 'mixture_waveform-handle mixture_waveform-handle-end';
            var css = {
                cursor: 'col-resize',
                position: 'absolute',
                left: '0px',
        ...
        (this.drag || this.resize) && (function () {
            ...
            var onDown = function (e) {
                ...
                if (e.target.tagName.toLowerCase() == 'handle') {
                    if (e.target.classList.contains('mixture_waveform-handle-start')) {
                        resize = 'start';
                    } else {
                        resize = 'end';
                    }
